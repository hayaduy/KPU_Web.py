...
# --- 2. FUNGSI AMBIL DATA LAPKIN (DENGAN NORMALISASI NAMA & TANGGAL) ---
def get_lapkin_data(nama_user, bulan_nama, tahun):
    try:
        ...
        if response.status_code == 200:
            ...
            # Normalisasi nama (buang gelar & spasi)
            def clean_n(n):
            ...
            for item in data_json:
                ...
                if val_nama == target_clean:
                    ...
                    # Parsing tanggal dari berbagai format (buang jamnya)
                    ...
                    if dt_obj and dt_obj.month == bulan_angka and dt_obj.year == tahun:
                        filtered_data.append({
                            ...
                            "tgl_full": f"{dt_obj.day} {bulan_nama} {tahun}", # Format rapi
    ...
    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
        ...
        if not data_lapkin:
            ...
            for i, d in enumerate(data_lapkin):
                ...
                worksheet.write(row, 1, d['tgl_full'], f_center) # Tanggal sudah konversi
