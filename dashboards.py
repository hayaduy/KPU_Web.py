...
def create_excel_file(user_nama, bulan_nama, tahun, ttd_nama):
    ...
    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
        ...
        # Tabel Header
        headers = ["No", "Hari / Tanggal", "Uraian Kegiatan", "Hasil Kerja", "Keterangan"]
        ...
        for tgl in range(1, 23): 
            ...
            worksheet.write(row, 2, kegiatan_default, f_border)
            worksheet.write(row, 3, "Laporan terselesaikan", f_border)
